...
#asyncio.run(TimeSeriesService.scrape_and_store_index_time_series(index=WorldIndex.S_P_500))
time_series = TimeSeriesService.get_index_time_series(index=WorldIndex.S_P_500)
print(time_series)